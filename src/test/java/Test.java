import cn.gyyx.frame.mybatis.generator.AutoGenerator;
import cn.gyyx.frame.mybatis.generator.InjectionConfig;
...
public class Test {
    ...
    public static void main(String[] args) {
            ...
            gc.setOutputDir("E://pro/");
            gc.setFileOverride(true);
            gc.setActiveRecord(true);
            gc.setEnableCache(false);// XML 二级缓存
            gc.setBaseResultMap(true);// XML ResultMap
            gc.setBaseColumnList(false);// XML columList
            gc.setAuthor("east.Fu");
            ...
            dsc.setUrl("jdbc:mysql://192.168.10.36:3306/db_gm?characterEncoding=utf8");
